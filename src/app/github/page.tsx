...
export default function GithubCode() {
  return (
    <div className="min-h-screen text-white pt-20">
      <div className="max-w-4xl mx-auto px-6">
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-[#007ACC] mb-4">GitHub API Component Code</h1>
          <p className="text-gray-300 text-lg">This demonstrates API integration and data fetching from GitHub in React.</p>
        </div>
